            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav" className={`${isHeaderOpen ? '' : 'closed'}`}>
                    ...
                    <Nav className="ms-lg-auto">
                        {user.authUser ? <Link to='/signin' className="nav-link"><span className="m-0 ms-1 nav-item">Hi {user.name}</span></Link> : <Link to='/signin' className="nav-link"><span className="m-0 ms-1 nav-item">Login</span></Link>}
                        <Link to='/signin' className="nav-link"><span className="m-0 ms-1 nav-item" onClick={() => {dispatch(logout())}}>Logout</span></Link>
